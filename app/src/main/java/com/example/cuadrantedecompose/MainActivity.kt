    ...
    Column(Modifier.fillMaxWidth()) {
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.primera_descripcion),
                backgroundColor = Color(0xFFEADDFF),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.segundo_titulo),
                description = stringResource(R.string.segunda_descripcion),
        ...
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.tercera_descripcion),
                backgroundColor = Color(0xFFB69DF8),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.cuarto_titulo),
                description = stringResource(R.string.cuarta_descripcion),
